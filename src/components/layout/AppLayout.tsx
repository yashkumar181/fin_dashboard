...
export default function AppLayout() {
  ...
  const openSearch = () => {
    // Triggers the Cmd+K command menu
  ...
  return (
    <div className="flex h-screen w-full bg-neutral-50 dark:bg-neutral-950">
      ...
      {/* PC Sidebar */}
      <aside className="hidden md:flex flex-col w-64 border-r bg-white dark:bg-neutral-900 border-neutral-200 dark:border-neutral-800 shrink-0">
      ...
      <main className="flex-1 overflow-y-auto pb-16 md:pb-0 flex flex-col min-w-0">
        {/* Top Header */}
        <header className="h-16 flex items-center justify-between px-6 border-b border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 shrink-0">
          ...
          {/* Mobile: Center Logo */}
          <span className="md:hidden text-lg font-bold text-neutral-900 dark:text-white absolute left-1/2 -translate-x-1/2">
            Finance Tracker
          </span>
          ...
          <div className="flex items-center gap-2 sm:gap-4 ml-auto">
            ...
            {/* Theme Toggle Button (Visible on Mobile & PC) */}
            <Button 
              variant="ghost" 
              size="icon" 
