...
// Generate valid years (requires user to be at least 18 years old)
...
export function OnboardingModal() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Ensure all date fields are selected
      ...
      <DialogContent className="sm:max-w-[500px] p-6 sm:p-8 [&>button]:hidden border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-950 shadow-2xl">
        ...
        <DialogHeader className="space-y-3 mb-4">
          ...
          <DialogDescription className="text-center text-base">
            Welcome, <span className="font-semibold text-neutral-900 dark:text-white">{user.firstName}</span>! We need two final details to activate your AI financial assistant.
          </DialogDescription>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            <Label htmlFor="phone" className="text-sm font-semibold text-neutral-900 dark:text-neutral-200">WhatsApp Number</Label>
